...
! function(t, e) {
  ...
  $.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', N.handleDismiss(new N)), _((function() {
      var t = y();
      if (t) {
          var e = t.fn[W];
  ...
  var Et = {
          ...
          effect: function(t) {
              ...
              null != s && ("string" != typeof s || (s = e.elements.popper.querySelector(s))) && gt(e.elements.popper, s) && (e.elements.arrow = s, e.modifiersData[n + "#persistent"] = {
                  padding: Ct("number" != typeof a ? a : xt(a, st))
              })
          },
  ...
  var It = {
          ...
          fn: function(t) {
              ...
              null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign(Object.assign({}, e.styles.popper), At(Object.assign(Object.assign({}, a), {}, {
                  offsets: e.modifiersData.popperOffsets,
                  position: e.options.strategy,
                  adaptive: r
              })))), null != e.modifiersData.arrow && (e.styles.arrow = Object.assign(Object.assign({}, e.styles.arrow), At(Object.assign(Object.assign({}, a), {}, {
  ...
  function Yt(t, e) {
      ...
      var i = e,
          ...
          p = i.padding,
          f = void 0 === p ? 0 : p,
          m = Ct("number" != typeof f ? f : xt(f, st)),
      ...
      fn: function(t) {
          ...
          if (!e.modifiersData[n]._skip) {
              for (var o = i.mainAxis, s = void 0 === o || o, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, d = i.boundary, u = i.rootBoundary, h = i.altBoundary, p = i.flipVariations, f = void 0 === p || p, m = i.allowedAutoPlacements, g = e.options.placement, v = ft(g), y = l || (v !== g && f ? function(t) {
                      ...
                      var e = Mt(t);
                      return [jt(t), e, jt(e)]
                  }(g) : [Mt(g)]), _ = [g].concat(y).reduce((function(t, i) {
                  ...
                  }), []), b = e.rects.reference, w = e.rects.popper, k = new Map, T = !0, S = _[0], C = 0; C < _.length; C++) {
                  var x = _[C],
                      E = ft(x),
                      O = "start" === qt(x),
                      A = [et, it].indexOf(E) >= 0,
                  ...
                  var z = Mt(D),
                      M = [];
                  if (s && M.push(L[E] <= 0), a && M.push(L[D] <= 0, L[z] <= 0), M.every((function(t) {
                          return t
                      }))) {
                      S = x, T = !1;
                      break
      ...
      Jt = {
          ...
          fn: function(t) {
              var e = t.state,
                  ...
                  T = e.rects.reference,
                  S = e.rects.popper,
                  C = "function" == typeof m ? m(Object.assign(Object.assign({}, e.rects), {}, {
                      placement: e.placement
                  })) : m,
                  x = {
                      x: 0,
              ...
              if (k) {
                  if (s) {
                      var E = "y" === b ? et : ot,
                          ...
                          N = H[O],
                          B = St(0, T[A], $[A]),
                          R = _ ? T[A] / 2 - z - B - W - C : M - B - W - C,
                          F = _ ? -T[A] / 2 + z + B + N + C : P + B + N + C,
                          ...
                          Q = k[b] + R - Y - U,
                          V = k[b] + F - Y,
                          K = St(p ? Math.min(L, Q) : L, I, p ? Math.max(D, V) : D);
                      k[b] = K, x[b] = K - I
                  }
                  if (a) {
                      var X = "x" === b ? et : ot,
  ...
  var oe = ne(),
      se = ne({
          defaultModifiers: [Dt, Zt, It, pt]
      }),
      re = ne({
          defaultModifiers: [Dt, Zt, It, pt, Gt, Qt, Jt, Et, Xt]
      }),
      ae = Object.freeze({
          __proto__: null,
          popperGenerator: ne,
  ...
  var xe = "tooltip",
      ...
      ze = function(t) {
          ...
          return s.enable = function() {
              ...
              if (null !== t) return "object" == typeof e && h(e) ? (e.jquery && (e = e[0]), void(this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void(this.config.html ? (this.config.sanitize && (e = Ce(e, this.config.allowList, this.config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
          }, s.getTitle = function() {
              ...
              return Object.keys(e).forEach((function(t) {
                  ...
                  show: t.delay,
                  hide: t.delay
              }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), f(xe, t, this.constructor.DefaultType), t.sanitize && (t.template = Ce(t.template, t.allowList, t.sanitizeFn)), t
  ...
  _((function() {
      ...
      if (t) {
          var e = t.fn[Me];
          t.fn[Me] = We.jQueryInterface, t.fn[Me].Constructor = We, t.fn[Me].noConflict = function() {
              return t.fn[Me] = e, We.jQueryInterface
          }
      }
  }));
  var Ne = "scrollspy",
  ...
  $.on(window, "load.bs.scrollspy.data-api", (function() {
      ...
      if (t) {
          var e = t.fn[Ne];
          t.fn[Ne] = Fe.jQueryInterface, t.fn[Ne].Constructor = Fe, t.fn[Ne].noConflict = function() {
              return t.fn[Ne] = e, Fe.jQueryInterface
          }
      }
  }));
  var qe = function(t) {
...
function(t) {
          ...
          getInline: function(i, n) {
              if (A(), i.src) {
                  ...
                  if (s.length) {
                      ...
                      r && r.tagName && (x || (C = o.hiddenClass, x = w(C), C = "mfp-" + C), E = s.after(x).detach().removeClass(C)), e.updateStatus("ready")
  ...
  t.magnificPopup.registerModule(L, {
      ...
      proto: {
          initAjax: function() {
              e.types.push(L), I = e.st.ajax.cursor, b(a + "." + L, z), b("BeforeChange." + L, z)
          },
          getAjax: function(i) {
...
function(t) {
  ...
  (e = function() {
    ...
    var i = Math.ceil(e.slideCount / e.options.slidesToShow),
    ...
    if (e.$dots) {
        ...
        e.$dots.attr("role", "tablist").find("li").each(function (o) {
            ...
            var button = t(this).find("button").first();
            button.attr({
                role: "tab",
    ...
    for (t = 0; t < r; t++) {
        if ("object" == typeof o || void 0 === o) {
            n[t].slick = new e(n[t], o); // Initialize Slick carousel with options
        } else {
            i = n[t].slick[o].apply(n[t].slick, s); // Call Slick carousel method
            if (void 0 !== i) return i; // Return the result of the method call
        }
    }
    return n;
}
